...
<title>App Móvil - Salvador Hairdressing</title>
    ...
    <div class="tp-fullscreen">
      <ul>
        <li data-transition="fade"> <img src="../c/img/app/main1.jpg"  alt="" data-bgposition="right top" data-bgfit="cover" data-bgrepeat="no-repeat" />
          <h1 class="tp-caption large sfr text-black" data-x="0" data-y="220" data-speed="900" data-start="800" data-easing="Sine.easeOut">Salvador Hairdressing<br>App Móvil</h1>
          <div class="tp-caption medium sfr" data-x="0" data-y="380" data-speed="900" data-start="1500" data-easing="Sine.easeOut"><h4>¡Toda la excelencia de Salvador Hairdressing, ahora en tus manos!</h4><br>
          ...
          <h4>Disponible para: <a href="#"><i class="fab padding-icon fa-apple"></i> IOS</a> <a href="#"><i class="fab padding-icon fa-android"></i> Android</h4></a>
        </li>
      </ul>
    </div>
