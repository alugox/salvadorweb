...
<title>Nosotros - Salvador Hairdressing</title>
      ...
      <div class="blog row">
          ...
          <div class="blog-posts classic-view">
            <div class="post">
              <div class="box text-center">
                <h2 class="post-title padding-bottom3">Misión</h2>
                <div class="post-content text-left">
                  <p>Exceder las expectativas de toda la familia, al proveer un servicio de belleza personalizado e integral, basado en la excelencia y a la vanguardia de las últimas innovaciones y tendencias, respaldados por recursos de calidad comprobada, los más reconocidos aliados comerciales y el más calificado, ético y responsable capital humano, con alto sentido de responsabilidad social.</p>
                </div>
                <!-- .post-footer --> 
              </div>
              <!-- /.box --> 
            ...
            <div class="post">
              <div class="box text-center">
                <h2 class="post-title padding-bottom3">Visión</h2>
                <div class="post-content text-left">
                  <p>Ser el concepto de belleza integral dirigido a toda la familia, más reconocido a nivel nacional e internacional, por nuestra trayectoria, calidad de atención y excelencia profesional.</p>
                </div>
                <!-- .post-footer --> 
              </div>
              <!-- /.box --> 
            ...
            <div class="post">
              <div class="box text-center">
                <h2 class="post-title padding-bottom3">Valores</h2>
                <div class="post-content text-left">
                  <ul>
                    <li>Humildad</li>
                    <li>Innovación</li>
        ...
        <aside class="col-sm-4 col-md-offset-1 sidebar side-color">
          <div class="sidebox widget">
            ...
            <span class="video-side"><iframe width="440" height="260" src="https://www.youtube.com/embed/fRyCrONn25g" frameborder="0" allowfullscreen></iframe></span>
            <h3 class="welcome-style">¡Bienvenido a la Excelencia!</h3>
