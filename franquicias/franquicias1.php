		...
		<form action="<?=$_SERVER['PHP_SELF'];?>" name="form1" method="post">
			...
			<div class="contenedor">
				<div style="margin-top:2px; width:100%;margin-botton:10px;float:left; ">
					...
					<?php if($exito<>"" && $_POST){?><div class="exito"><div>Su informaci&oacute;n ha sido enviada exitosamente.</div></div><?php }?>
				</div>
				...
				<select name="f" id="f">
				      ...
				      <option value="estilista" <?php=iif($f=="estilista",'selected="selected"',"")?>>Franquiciado con Unidad de Negocio</option>
