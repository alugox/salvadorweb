...
<title>Salvador Hairdressing - ¡Bienvenido a la Excelencia!</title>
...
<body>
<div id="preloader2"><div class="textload">¡Bienvenido a la Excelencia!</div><div id="status"><div class="spinner"></div></div></div>
<main class="body-wrapper">
  ...
  <div class="tp-fullscreen-container revolution">
    <div class="tp-fullscreen">
      <ul>
        <li data-transition="fade"> <img src="c/img/bg6.jpg"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
        <li data-transition="fade"> <img src="c/img/bg1.jpg"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
        <li data-transition="fade"> <img src="c/img/bg7.jpg"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
        </li>
        <li data-transition="fade"> <img src="c/img/bg2.jpg"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
        </li>
        </li>
        </li>
      </ul>
          ...
          <div style="padding-top:10px;padding-bottom: 10px;">
            <div class="cbp-panel">
              <div class="cbp cbp-onepage-grid">
                <div class="cbp-item"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="/c/img/main/b1-full.jpg" data-title-id="title-1">
                ...
                <p>Hoy recibimos con felicidad y orgullo el <b>Mara De Oro</b> como Franquicia venezolana con mayor expansión internacional.</p>
                  ...
                  <div class="cbp-item"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="/c/img/main/b2-full.jpg" data-title-id="title-2">
                  <div class="cbp-caption-defaultWrap"> <img src="c/img/main/b2.jpg" alt="" /> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title"><span class="cbp-plus"></span></div>
                ...
                <h3>Tips: Aceite de Argán Salvador</h3>
  ...
  <div class="dark-wrapper">
    <div class="container inner">
      <div class="thin">
        <h3 class="section-title text-center">Un mundo, <span style="font-style: underline;">tú mundo</span></h3>
      </div>
        ...
        <div id="js-grid-mosaic" class="cbp">
          <div class="cbp-item print motion"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/5c.jpg"  data-title-id="title-main1">
            <div class="cbp-caption-defaultWrap">
              <div class="fix">
                ...
                <div class="desc">
                    <p class="desc_content" style=""><b>Conoce nuestros 6 Modelos de Negocio y Franquicias.</b></p>
                </div>
              </div>
            </div>
            <div class="cbp-caption-activeWrap">
            ...
            <div id="title-main1" class="hidden">
              <h3>Bienvenido a la Excelencia Salvador</h3>
          ...
          <div class="cbp-item print web"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/7b.jpg" data-title-id="title-main2">
            <div class="cbp-caption-defaultWrap">
              ...
              <div class="desc">
                <p class="desc_content" style=""><b>¡Sé un Mystery Shopper!</b></p>
              </div>
              </div>
            </div>
            <div class="cbp-caption-activeWrap">
            ...
            <div id="title-main2" class="hidden">
              <h3>Sé un Mystery Shopper para Salvador Hairdressing</h3>
          ...
          <div class="cbp-item print"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/5.jpg" data-title-id="title-main5">
            <div class="cbp-caption-defaultWrap"> 
              <div class="fix">
                ...
                <div class="desc">
                    <p class="desc_content" style=""><b>¡Programa tu cita con nuestra App para dispositivos móvil!</b></p>
                </div>
              </div>
            </div>
            <div class="cbp-caption-activeWrap">
          ...
          <div id="title-main5" class="hidden">
              <h3>Conoce todo sobre la App Salvador Hairdressing</h3>
          ...
          <div class="cbp-item web logo"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/3b.jpg" data-title-id="title-main3">
            ...
            <div id="title-main3" class="hidden">
              <h3>¿Quieres ser VIP?</h3>
              <p>Acumula puntos al tener una ClientCard Salvador, los cuales podrás cambiar por descuentos de hasta el 75% en el pago de tu factura.</p>
              <p><b><a href="/cc">¡Conoce más!</a></b></p>
            </div>
          </div>
          ...
          <div class="cbp-item web"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/4d.jpeg" data-title-id="title-main4">
            ...
            <div class="cbp-caption-activeWrap">
              ...
              <h3>Academia Salvador - <i>Aprende un arte</i></h3>
          ...
          <div class="cbp-item print logo"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="c/img/main/8b.jpg" data-title-id="title-main8">
            <div class="cbp-caption-defaultWrap">
              ...
              <div class="desc">
                    <p class="desc_content" style=""><b>Esmaltes Salvador Professional</b></p>
                </div>
              </div>
            </div>
            <div class="cbp-caption-activeWrap">
              ...
              <h3>Esmaltes Salvador Profesional</h3>
  ...
  <div class="parallax3 inverse-wrapper customers" style="background-image: url(c/img/seccion.jpg); background-size: cover; padding-top: 150px; padding-bottom: 150px;">
        ...
        <div class="col-md-8">
          <div class="item post">
              ...
              <div class="box text-center">
                <div class="category cat16"><span class="sinpadding"><a href="/ubicaciones">Ubicaciones</a></span></div>
                <p><div class="meta"><span class="comments"><a href="/ubicaciones"> Cada vez más cerca de tí</a></span></div></p>
              </div>
          </div>
        </div>
      </div> 
